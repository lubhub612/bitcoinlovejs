...
var priv = vcoinjs.address.mkPrivKey('chris p. bacon, defender of the guardians')
...
var pubKey = vcoinjs.address.privKeyToPubKey(priv)
...
var zAddr = vcoinjs.address.pubKeyToAddr(pubKey)
...
var txobj = vcoinjs.transaction.createRawTx([{txid: '196173ec34d22a52cc689a21d01dd33b633671cbe1141e7e66240c7f3b4ccf7b', vout: 0}], [{address: 't1aYp69J595Rhaof2AEFuEvJjLWVboddB2x', satoshis: 100000}])
// vcoinjs.transaction.serializeTx(txobj)
...
var tx0 = vcoinjs.transaction.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c')
// vcoinjs.transaction.serializeTx(tx0)
...
// You can now do vcoin-cli sendrawtransaction `SERIALIZED_TRANSACTION`
```
