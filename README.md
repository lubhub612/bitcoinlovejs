# bitcoinlovejs
Dead simple and easy to use JavaScript based Bitcoinlove library. Inspired by [pybitcointools](https://github.com/vbuterin/pybitcointools)

# Getting started (Dev)
```bash
git clone https://github.com/lubhub612/bitcoinlovejs.git
cd bitcoinlovejs
yarn install
yarn build
...
# Example usage
```javascript
var bitcoinlovejs = require('bitcoinlovejs')

var priv = bitcoinlovejs.address.mkPrivKey('chris p. bacon, defender of the guardians')
// 2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c

var privWIF = bitcoinlovejs.address.privKeyToWIF(priv)
// 5J9mKPd531Tk4A73kKp4iowoi6EvhEp8QSMAVzrZhuzZkdpYbK8

var pubKey = bitcoinlovejs.address.privKeyToPubKey(priv)
...
var zAddr = bitcoinlovejs.address.pubKeyToAddr(pubKey)
...
var txobj = bitcoinlovejs.transaction.createRawTx([{txid: '196173ec34d22a52cc689a21d01dd33b633671cbe1141e7e66240c7f3b4ccf7b', vout: 0}], [{address: 't1aYp69J595Rhaof2AEFuEvJjLWVboddB2x', satoshis: 100000}])
// bitcoinlovejs.transaction.serializeTx(txobj)
...
var tx0 = bitcoinlovejs.transaction.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c')
// bitcoinlovejs.transaction.serializeTx(tx0)
...
// You can now do bitcoinlove-cli sendrawtransaction `SERIALIZED_TRANSACTION`
```
